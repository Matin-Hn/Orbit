...
class AuthorizationService:
    ...
    async def can_modify_comment(self, user: User, comment: Comment) -> bool:
        ...
        result = await self.db.execute(select(Video).filter(Video.id == comment.video_id))
    ...
    async def can_pin_comment(self, user: User, comment: Comment) -> bool:
